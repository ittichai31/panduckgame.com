...
const translations = {
  en: {
    ...
    cats: {
      blackCat: { name: "Black Cat", description: "You are quiet magic: observant, loyal, and a little impossible to fully understand. People feel special when you choose them.", trait: "Your charm is subtle: you notice small details, protect your favorite people, and prefer trust over noise." },
      calico: { name: "Calico", description: "You are colorful confidence with opinions. Sweet, bold, surprising, and absolutely not interested in being predictable.", trait: "Your personality has range: creative one minute, decisive the next, and always more complex than people expect." },
      greyTabby: { name: "Grey Tabby", description: "You are clever curiosity. You like movement, puzzles, windows, little missions, and knowing what every room is doing.", trait: "Your best trait is alert playfulness: you turn ordinary moments into little investigations." },
      maineCoon: { name: "Maine Coon", description: "You are the gentle giant of the friend group: steady, warm, outdoorsy-at-heart, and quietly protective.", trait: "People lean on your calm confidence because you make big feelings feel manageable." },
      orangeCat: { name: "Orange Cat", description: "You are sunshine with a suspiciously chaotic plan. Warm, funny, snack-motivated, and impossible to stay mad at.", trait: "Your gift is joyful momentum: you make rooms brighter, louder, and a little more ridiculous in the best way." },
      ragdoll: { name: "Ragdoll", description: "You are soft trust. Calm, affectionate, and happiest when the world slows down enough for a good cuddle.", trait: "Your comfort energy is powerful: you help people unclench just by being near them." },
      britishShorthair: { name: "British Shorthair", description: "You are plush dignity. Composed, independent, deeply comfortable, and much more affectionate than your face admits.", trait: "You show love through consistency: steady presence, excellent taste, and a very selective soft side." },
      siamese: { name: "Siamese", description: "You are dramatic brilliance. Social, vocal, smart, and very ready to explain exactly what should happen next.", trait: "Your mind moves fast, your opinions arrive fully formed, and your affection comes with conversation." },
      tuxedo: { name: "Tuxedo", description: "You are formal mischief. Charming, theatrical, clever, and somehow always dressed for the most interesting part of the day.", trait: "Your signature trait is clever timing: you know when to be elegant, when to be funny, and when to steal the scene." },
      whiteCat: { name: "White Cat", description: "You are serene moonlight. Elegant, sensitive, dreamy, and full of soft boundaries that deserve respect.", trait: "Your strength is gentle clarity: you bring calm into a space while still knowing exactly what feels right for you." }
    }
  },
  th: {
    quiz: {
      eyebrow: "ควิซแมวเดสก์ท็อป",
      title: "แมวในใจของคุณคือแมวแบบไหน?",
      language: "ภาษา",
      intro: "ตอบคำถามบุคลิกภาพสั้น ๆ 10 ข้อ แล้วมาดูกันว่าแมวเดสก์ท็อปตัวไหนเข้ากับนิสัยของคุณที่สุด",
      start: "เริ่มควิซ",
      home: "กลับหน้าแรก"
    },
    result: {
      ...
      adopt: "ทำไมไม่รับเลี้ยงสักตัววันนี้เลยล่ะ? แมวตัวนี้พร้อมมานอนก้อน กะพริบตา และอยู่เป็นเพื่อนบนหน้าจอของคุณแล้ว",
      share: "ฉันได้ {cat} จากควิซแมวของ Panduck"
    },
    questions: {
      afternoon: {
        text: "บ่ายในฝันของคุณคือ...",
        answers: {
          quiet: "ขดตัวอยู่ในมุมเงียบ ๆ ที่มีแสงนุ่ม ๆ",
          explore: "ออกไปสำรวจที่ใหม่กับคนที่คุณชอบ",
          party: "ชวนคุย เล่นสนุก และสร้างความวุ่นวายนิดหน่อย",
          admired: "ทำสิ่งของตัวเองไป และให้คนอื่นชื่นชมจากระยะที่พอดี"
        }
      },
      partyRole: {
        text: "เวลาอยู่ในปาร์ตี้ คุณมักจะเป็น...",
        answers: {
          mystery: "คนลึกลับที่ใคร ๆ ก็อยากรู้จักมากขึ้น",
          storyteller: "คนเสียงดัง ตลก และเล่าเรื่องเก่ง",
          snacks: "เพื่อนใจเย็นที่นั่งเฝ้าขนม",
      ...
      affection: {
        text: "คุณแสดงความรักแบบไหน?",
        answers: {
          loyal: "อยู่ข้าง ๆ อย่างเงียบ ๆ แต่มั่นคง",
          talk: "คุย เช็กอิน และส่งเสียงทักตลอด",
          clingy: "กอดแน่นแบบนุ่มฟูทั้งตัว",
          tease: "แหย่เล่นด้วยความเอ็นดู"
        }
      },
      routine: {
        text: "ถ้ามีคนเปลี่ยนกิจวัตรของคุณ คุณจะ...",
        answers: {
          snacks: "ปรับตัวได้ ถ้ามีขนมช่วยปลอบใจ",
          supervise: "บ่นก่อน แล้วค่อยคุมสถานการณ์ต่อ",
          observe: "ถอยไปสังเกตก่อน",
          pretend: "ทำเหมือนไม่สน แต่จริง ๆ สนมาก"
        }
      },
      friends: {
        text: "เพื่อน ๆ มักบอกว่าคุณเป็นคน...",
        answers: {
          gentle: "อ่อนโยนและไว้ใจได้",
          funny: "ตลกและวุ่นวายนิด ๆ",
          stylish: "มีสไตล์และฉลาดทันคน",
          calm: "นิ่ง สุขุม และทำให้ประทับใจยาก"
        }
      },
      adventure: {
      ...
      attention: {
        ...
        answers: {
          gentle: "ความสนใจนุ่มนวล ไม่เยอะเกินไป",
      ...
      motto: {
        ...
        answers: {
          ...
          thoughts: "ฉันมีความเห็น และคุณจะได้ฟัง",
    ...
    cats: {
      blackCat: { name: "แมวดำ", description: "คุณคือเวทมนตร์เงียบ ๆ ช่างสังเกต ซื่อสัตย์ และอ่านใจยากนิดหน่อย ใครที่คุณเลือกให้อยู่ใกล้จะรู้สึกพิเศษมาก", trait: "เสน่ห์ของคุณอยู่ที่ความละเอียดอ่อน คุณมองเห็นสิ่งเล็ก ๆ และปกป้องคนสำคัญแบบไม่ต้องพูดเยอะ" },
      calico: { name: "แมวสามสี", description: "คุณคือความมั่นใจหลากสี มีความเห็นชัดเจน น่ารัก กล้า และไม่ยอมเป็นคนที่เดาง่าย", trait: "นิสัยของคุณมีหลายเฉด ทั้งสร้างสรรค์ เด็ดขาด และซับซ้อนกว่าที่คนอื่นคิดเสมอ" },
      greyTabby: { name: "แมวลายเทา", description: "คุณคือความอยากรู้อยากเห็นที่ฉลาด ชอบการเคลื่อนไหว ปริศนา หน้าต่าง และภารกิจเล็ก ๆ", trait: "จุดเด่นของคุณคือความขี้เล่นที่ตื่นตัว คุณเปลี่ยนเรื่องธรรมดาให้กลายเป็นการสำรวจเล็ก ๆ ได้เสมอ" },
      maineCoon: { name: "เมนคูน", description: "คุณคือยักษ์ใจดีของกลุ่มเพื่อน มั่นคง อบอุ่น มีใจรักการผจญภัย และคอยปกป้องอย่างเงียบ ๆ", trait: "คนอื่นพึ่งพาความนิ่งของคุณได้ เพราะคุณทำให้เรื่องใหญ่ดูรับมือได้มากขึ้น" },
      orangeCat: { name: "แมวส้ม", description: "คุณคือแสงแดดที่มาพร้อมแผนป่วน ๆ อบอุ่น ตลก รักขนม และโกรธไม่ลงจริง ๆ", trait: "พรสวรรค์ของคุณคือพลังสนุก คุณทำให้ห้องสว่างขึ้น เสียงดังขึ้น และน่าขำขึ้นในแบบที่ดีมาก" },
      ragdoll: { name: "แร็กดอลล์", description: "คุณคือความไว้ใจที่นุ่มฟู ใจเย็น ขี้อ้อน และมีความสุขที่สุดเมื่อโลกช้าลงพอให้ได้พักใกล้ ๆ กัน", trait: "พลังปลอบใจของคุณแรงมาก แค่อยู่ใกล้ก็ทำให้คนอื่นรู้สึกผ่อนคลายขึ้น" },
      britishShorthair: { name: "บริติช ชอร์ตแฮร์", description: "คุณคือความสง่างามนุ่มฟู สุขุม รักอิสระ สบายใจกับตัวเอง และขี้รักกว่าหน้าตาบอก", trait: "คุณแสดงความรักด้วยความสม่ำเสมอ อยู่ตรงนั้นเสมอ มีรสนิยมดี และมีด้านนุ่ม ๆ ที่เลือกให้เห็นเฉพาะบางคน" },
      siamese: { name: "วิเชียรมาศ", description: "คุณคือความฉลาดแบบมีดราม่า เข้าสังคมเก่ง ช่างพูด และพร้อมอธิบายว่าทุกอย่างควรเป็นอย่างไร", trait: "ความคิดของคุณไวมาก ความเห็นชัด และความรักของคุณมักมาพร้อมบทสนทนายาว ๆ" },
      tuxedo: { name: "แมวทักซิโด้", description: "คุณคือความซนในชุดทางการ มีเสน่ห์ ชอบเล่นใหญ่ ฉลาด และเหมือนแต่งตัวพร้อมเข้าฉากสำคัญเสมอ", trait: "จุดเด่นของคุณคือจังหวะที่ดี รู้ว่าเมื่อไรควรดูเท่ เมื่อไรควรตลก และเมื่อไรควรขโมยซีน" },
      whiteCat: { name: "แมวขาว", description: "คุณคือแสงจันทร์ที่สงบ สง่างาม อ่อนไหว ช่างฝัน และมีขอบเขตนุ่ม ๆ ที่ควรได้รับการเคารพ", trait: "พลังของคุณคือความชัดเจนที่อ่อนโยน คุณทำให้พื้นที่รอบตัวสงบลง แต่ก็รู้ดีว่าอะไรเหมาะกับใจตัวเอง" }
    }
  },
...
function renderResult(id) {
  ...
  resultDescription.textContent = [cat.description, cat.trait].filter(Boolean).join(" ");
